...
Public Class frmdirecciones
    ...
    Private Sub buscar()
        Try
            ...
            dv.RowFilter = cbodirecciones.Text & " like '" & txtbuscar.Text & "%'"
    ...
    Private Sub btneditar_Click(sender As Object, e As EventArgs) Handles btneditar.Click
        ...
        If result = DialogResult.OK Then
            ...
            If Me.ValidateChildren = True And txtcalle.Text <> "" And txtnumero.Text <> "" And txtcolonia.Text <> "" Then
                Try
                    Dim dts As New vdireccion

                    Dim fuc As New fdireccion
                    dts.gcalle = txtcalle.Text
                    dts.gnumero = txtnumero.Text
                    dts.gcolonia = txtcolonia.Text
            ...
            Try
                For Each row As DataGridViewRow In datalistado.Rows
                    ...
                    If marcado Then
                        ...
                        Dim vdb As New vdireccion
                        Dim func As New fdireccion
